   ...
   <view>
      ...
      <view class="address-section">
         <view class="order-content">
            <text class="cuIcon-location text-grey margin-xs" style="font-size:48upx"></text>
            <view class="cen">
               <view class="top">
                  <text class="name">{{selectAddress.realName}}</text>
            ...
            <text class="yticon cuIcon-right margin" style="font-size:32upx" @tap="toAddress('')"></text>
         </view>
      ...
      <view class="goods-section">
         <view class="g-header b-b">
            <image class="logo" :src="currentShop.logoImage"></image>
            <text class="name">{{currentShop.name}}</text>
         </view>
         <!-- 商品列表 -->
         <view class="g-item">
            <image :src="sku.coverImageUrls[0]"></image>
            <view class="right">
               <view class="title clamp">{{currentSpu.name}}</view>
               <view class="spec">{{sku.name}}</view>
...
export default class CreateOrder extends BaseView {
   ...
   get sku() {
      return ShopModule.getCurrentSku;
   }
