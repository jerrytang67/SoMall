export const menu = [
    ...
    { text: "应用管理", link: "/app-management/apps", icon: "fab fa-app-store-ios" },
    { text: "审计日志", link: "/auditLog/auditLogs", icon: "icon-info" },
    ...
    { text: "滚动广告", link: "/mall/swiper", icon: "fas fa-audio-description" },
