        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadImgUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AuditName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Zan = table.Column<int>(type: "int", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RealName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Phone = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    LocationLabel = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    LocationAddress = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    NickName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    IsDefault = table.Column<bool>(type: "bit", nullable: false),
                    DatetimeLast = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BuyerName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    BuyerAvatar = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTimeEnable = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoImage = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    CoverImage = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    BussinessHours = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadImgUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    PhoneBackup = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    State = table.Column<int>(type: "int", nullable: false),
                    AvblBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UnavblBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalWithdrawals = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    LastLoginDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Lat = table.Column<double>(type: "float", nullable: true),
                    Lng = table.Column<double>(type: "float", nullable: true),
                    LocationLabel = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    LocationAddress = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    LocationType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Body = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    BillNo = table.Column<string>(type: "nvarchar(48)", maxLength: 48, nullable: false),
                    OpenId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    MchId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    ...
                    ShareFromUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PayOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    AddressRealName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    AddressNickName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    AddressPhone = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    AddressLocationLabel = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    AddressLocationAddress = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ManId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    out_trade_no = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    result_code = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    fee_type = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    return_code = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    total_fee = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    mch_id = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    cash_fee = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    openid = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    transaction_id = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    sign = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    bank_type = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    appid = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    time_end = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    trade_type = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    nonce_str = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    is_subscribe = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    CouponAmount = table.Column<int>(type: "int", nullable: false),
                    PaymentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UsedTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UsedOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UsedOrderType = table.Column<int>(type: "int", nullable: true),
                    ShopId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Introducting = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseNotesCommon = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateTimeStart = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DateTimeEnd = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    LimitBuyCount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpuName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    SkuName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    SkuUnit = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    SkuCoverImageUrl = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceHolder = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    DefaultValue = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ErrorText = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    IsRequired = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    IsDisable = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsMulti = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    SaveToLocal = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AppName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ProductSpuId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImageUrls = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateTimeStart = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DateTimeEnd = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ShopId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CommissionPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CommissionEnable = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
