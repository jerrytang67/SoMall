...
namespace TT.Abp.Mall.Domain.Pays
{
    public class PayOrder : FullAuditedAggregateRoot<Guid>, IMultiTenant, IMultiShop
    {
        ...
        public virtual bool IsSuccessPay { get; protected set; }
        public virtual DateTime? SuccessPayTime { get; protected set; }

        #endregion

        #region 退款相关

        public virtual bool IsRefund { get; protected set; }
